...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-5 md:px-8 py-12 sm:py-20 md:py-32 text-center">
        {/* Badge */}
        <MotionReveal delay={0.05} y={14}>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#d4af37]/20 bg-[#d4af37]/5 mb-8 shadow-[0_0_40px_rgba(212,175,55,0.08)]">
            ...
            <span className="text-xs font-medium tracking-wider text-[#d4af37] uppercase">Verified Call Girls &amp; Premium Escorts</span>
          </div>
        </MotionReveal>

        {/* H1 — LCP element, no animation wrapper to avoid render delay */}
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-[#a0a0b0] leading-relaxed mb-10">
          Vijayawada&apos;s most trusted call girls and escort service. Verified companions with real photos, instant WhatsApp booking, hotel visits, and complete privacy — available 24/7 across all areas.
        </p>
