module.exports = {
  ...
  transform: async (config, path) => {
    ...
    const mediumPriority = ['/luxury-companionship', '/premium-models', '/whatsapp-booking', '/benz-circle-escorts', '/mg-road-vijayawada', '/governorpet-escorts', '/railway-station-escorts-vijayawada', '/gannavaram-escorts', '/patamata-companionship', '/guntur-escorts', '/amaravati-escorts', '/mangalagiri-escorts', '/faq', '/contact'];
